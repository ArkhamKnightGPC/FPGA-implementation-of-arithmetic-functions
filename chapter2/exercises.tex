...
\begin{itemize}
    ...
    \item a data path including two carry-save adders and several registers where computation is performed over 3 cycles
    \item a data path including one carry-save adders and several registers where computation is performed over 4 cycles
\end{itemize}
\end{tcolorbox}
\end{document}